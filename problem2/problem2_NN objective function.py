...
xx_train1 = np.linspace(-1.5, 1.5, 100)
xx_train2 = np.linspace(-1.5, 1.5, 100)
xv, yv = np.meshgrid(xx_train1, xx_train2)
x_train1 = xv.flatten()
x_train2 = yv.flatten()
y_train = -10 * (np.cos(x_train1*x_train2) - x_train1*x_train2/100 - np.sin(x_train1+x_train2)*(x_train1+x_train2))
